...
export type FirebaseContextType = CanRemove & {
  ...
  register: (email: string, password: string, firstName: string, lastName: string) => Promise<void>;
  uploadFileToStorage: (file: any, user: any) => Promise<string>;
  addToFavourites: (user: any) => Promise<void>;
  addToHistory: (user: any) => Promise<void>;
  getFavourites: (user: any) => Promise<any | null>;
};
