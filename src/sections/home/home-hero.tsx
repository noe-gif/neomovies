    ...
    >
        ...
        <Stack spacing={1.5} direction={{ xs: 'column-reverse', sm: 'row' }} sx={{ mb: 5 }}>
          <Stack alignItems="center" spacing={2}>
            <Button
              ...
              size="large"
              variant="contained"
              startIcon={<Iconify icon="uis:unlock" width={24} />}
            >
              Get started
            </Button>
          </Stack>
      ...
      <Stack spacing={3} sx={{ textAlign: 'center' }}>
        ...
        <Stack spacing={2} direction="row" justifyContent="center">
          {['computer', 'tablet', 'smartphone'].map((icon) => (
            <m.div key={icon} variants={varFade().in}>
              <Box
                component="img"
                alt={icon}
                src={`/assets/icons/platforms/${icon}.svg`}
    ...
    >
      ...
      >
        <Box
          ...
          src={
            lightMode
              ? `/assets/images/home/hero/test.webp`
